        ...
        for (let i: number = 0; i < prettyArray.length; i++) {
            ...
            switch (prettyArray[i]) {
                ...
                case "triangle":
                    ...
                    let triangle: Triangle = new Triangle(position, info[6]);
                ...
                case "circle":
                    ...
                    let circle: Triangle = new Triangle(positionCircle, info[6]);
                    circle.draw(crcMain);
                    info = [];
                    figures.push(circle);
                    break;
                ...
                case "heart":
                    ...
                    let heart: Triangle = new Triangle(positionHeart, info[6]);
                    heart.draw(crcMain);
                    info = [];
                    figures.push(heart);
                    break;
                ...
                case "star":
                    ...
                    let star: Triangle = new Triangle(positionStar, info[6]);
                    star.draw(crcMain);
                    info = [];
                    figures.push(star);
                    break;
