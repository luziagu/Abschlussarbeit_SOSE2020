...
(function (zauberbild) {
    ...
    async function getImage(_pictureTitle) {
        ...
        zauberbild.crcMain.canvas.width = parseInt(prettyArray[3]);
        zauberbild.crcMain.canvas.height = parseInt(prettyArray[4]);
        ...
        for (let i = 0; i < prettyArray.length; i++) {
            switch (prettyArray[i]) {
                case "triangle":
                    ...
                    let triangle = new zauberbild.Triangle(position, info[11]);
                ...
                case "circle":
                    ...
                    let circle = new zauberbild.Triangle(positionCircle, info[11]);
                ...
                case "heart":
                    ...
                    let heart = new zauberbild.Triangle(positionHeart, info[11]);
                ...
                case "star":
                    ...
                    let star = new zauberbild.Triangle(positionStar, info[11]);
